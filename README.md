...
# Run all 5 demo scenarios automatically
python main.py --demo
...
Run `python main.py --demo` to execute all five:
...
| SUPP-1 | Support | Return request for recent order O0015 |
| SUPP-2 | Support | Return of clearance order O0049 (should be denied) |
...
| `get_order(order_id)` | Order details by ID |
